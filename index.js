//Your Code here
let firstAnswer = window.prompt('You approach a fork in the road. Do you head Left or Right?')
if(firstAnswer === 'Left'){
...
if(thirdAnswer === 'Stay'){
    ...
    let thirdAnswer = window.prompt ('You come across a chamber that reaches upward to a shining light above. There is a long, winding staircase, and a much quicker, but rickety-looking ladder that leads up toward the light. Which do you take? Type Ladder or Staircase.')};
if(thirdanswer === 'Ladder'){
    ...
    let secondAnswer = window.prompt(`You come across a snoring dragon. On the other side of him, you see a shiny chest of treasure. Another path would lead you away from the dragon altogether. Which path do you take? Type Past the dragon or Away from the dragon.`)
if (secondAnswer === 'Past the dragon'){
    let thirdAnswer = window.prompt ('The dragon wakes up and sits upright. You only have a moment to respond, to stay or run. Type Stay or Run.');
if (thirdAnswer === 'Stay'){
    ...
    let thirdAnswer = window.prompt ('After walking a while longer, you come across a shiny blue flower. It is so beautiful that you decide you must either draw it or pick it. Which do you do? Type Draw it or Pick it.');
